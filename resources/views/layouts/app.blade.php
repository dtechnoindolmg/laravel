...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/11.4.16/sweetalert2.min.css"
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            {{-- @include('layouts.tittlepage', ['tittle' => {{ $title }}]) --}}
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2022 <a href="https://adminlte.io">Dtechnoindo.com</a>.</strong> All rights
            reserved.
        </footer>
    </div>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.13/js/select2.min.js"
        ...
        crossorigin="anonymous" referrerpolicy="no-referrer" defer></script>
    {{-- Moment --}}
    <script src="https://cdn.jsdelivr.net/npm/moment@2.29.3/moment.min.js" defer></script>
    {{-- DatetinePicker --}}
